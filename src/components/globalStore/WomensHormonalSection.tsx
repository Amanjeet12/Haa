...
export function WomensHormonalSection({
  title,
  description,
  products,
  quantities,
              ...
              <View style={styles.art}>
                ...
                {product.discount_percentage > 0 ? (
                  <View style={styles.badge}>
                    <AppText style={styles.badgeText} weight="800">
...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  heading: { fontSize: 19, lineHeight: 23, letterSpacing: -0.4 },
  ...
  art: { aspectRatio: 1.25, overflow: 'hidden', backgroundColor: '#F5E8EC' },
  ...
  badgeText: { fontSize: 6, lineHeight: 8 },
  body: { flex: 1, minHeight: 141, padding: 8 },
  brand: { fontSize: 7, lineHeight: 9, letterSpacing: 0.35 },
  name: { marginTop: 3, fontSize: 11, lineHeight: 14 },
  detail: { marginTop: 4, fontSize: 7, lineHeight: 10 },
  priceRow: {
    flexDirection: 'row',
    alignItems: 'flex-end',
  ...
  arrivalLabel: { textAlign: 'right', fontSize: 6, lineHeight: 8 },
  arrival: { textAlign: 'right', fontSize: 7, lineHeight: 9 },
  add: {
    height: 38,
    marginTop: 'auto',
    borderWidth: 1,
  ...
  addText: { fontSize: 10, lineHeight: 14 },
  stepper: {
    height: 38,
    marginTop: 'auto',
    borderRadius: 10,
