...
const groups: Array<{
...
}> = [
  {
    ...
    more: '+4 more',
    colors: ['#DDF7F4', '#F2FBFA'],
    images: [
      { source: images.careImage, position: 'center' },
      { source: images.onboardingCards, position: 'bottom' },
    ],
  },
  {
    title: 'Daily wellness',
    more: '+6 more',
    colors: ['#E7F2FC', '#F3F8FD'],
    images: [
      { source: images.onboardingCards, position: 'center' },
      { source: images.careImage, position: 'top' },
    ],
  },
  {
    title: 'Personal care',
    more: '+3 more',
    colors: ['#FDE8EE', '#FFF4F7'],
    images: [
      { source: images.homeBanner, position: 'center' },
      { source: images.onboardingCards, position: 'bottom' },
    ],
  },
];
...
const products: Array<{
...
}> = [
  {
    ...
    price: '₹249',
    oldPrice: '₹265',
    image: { source: images.careImage, position: 'center' },
  },
  {
    brand: 'HAA CARE',
    name: 'Gentle Intimate\nWipes',
    detail: '20 wipes',
    discount: '8% OFF',
    price: '₹149',
    oldPrice: '₹162',
    image: { source: images.onboardingCards, position: 'bottom' },
  },
  {
    brand: 'INTIMATE CARE',
    name: 'Water-Based\nPersonal Lubricant',
    ...
    price: '₹299',
    oldPrice: '',
    image: { source: images.homeBanner, position: 'center' },
  },
];

export function FrequentlyBoughtSection({
  onSeeAll,
  onGroupPress,
  onAdd,
}: {
  onSeeAll: () => void;
  onGroupPress: (category: string) => void;
  ...
  return (
    <View style={styles.root}>
      ...
      <AppText color={theme.colors.textMuted} style={styles.subtitle}>
        Grouped from the items you purchase most
      </AppText>
            ...
            style={[
              styles.groupCard,
              {
                backgroundColor: theme.isDark
                  ...
                  : colors[1],
                borderColor: theme.isDark ? theme.colors.border : colors[0],
              },
            ]}
          >
            <View style={styles.groupArt}>
              ...
              <View
                style={[
                  styles.miniTile,
                  styles.miniTileFront,
                  { backgroundColor: theme.colors.surface },
                ]}
              >
                <Image
                  resizeMode="cover"
                  source={groupImages[1].source}
                  style={styles.demoImage}
                />
              </View>
            ...
            <AppText numberOfLines={2} style={styles.groupTitle} weight="800">
              {title}
            </AppText>
          </Pressable>
        ))}
        ...
        style={[
          styles.bottomAction,
          {
            backgroundColor: theme.isDark
              ...
              : '#EAF7F4',
            borderColor: theme.isDark ? theme.colors.border : '#D5EAE7',
          },
        ]}
      >
        ...
        <AppText style={styles.actionText} weight="800">
          See all frequently bought
        </AppText>
      ...
      >
        ...
        <AppText style={styles.actionText} weight="800">
          See all Protection & intimate care
        </AppText>
        <ChevronRight color={theme.colors.text} size={16} />
      </Pressable>
    </View>
