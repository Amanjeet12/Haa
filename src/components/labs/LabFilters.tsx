      ...
      <View style={styles.searchRow}>
        ...
        >
          ...
          <TextInput
            ...
            placeholder="Search lab name or disease"
...
const styles = StyleSheet.create({
  ...
  filterText: { fontSize: 10, lineHeight: 13 },
  count: {
    width: 16,
    height: 16,
    borderRadius: 8,
  ...
  countText: { fontSize: 8, lineHeight: 10 },
  chips: { gap: 7, paddingHorizontal: 16, paddingVertical: 10 },
  chip: {
    height: 27,
    paddingHorizontal: 11,
    borderRadius: 14,
  ...
  chipText: { fontSize: 8, lineHeight: 10 },
});
