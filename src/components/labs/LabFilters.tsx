  ...
  return (
    <View style={styles.root}>
      <View style={styles.searchRow}>
        ...
        <Pressable onPress={onFilterPress} style={[styles.filterButton, { backgroundColor: appliedCount ? theme.colors.primary : theme.colors.text }]}>
...
const styles = StyleSheet.create({
  ...
  filterButton: { height: 42, paddingHorizontal: 11, borderRadius: 13, flexDirection: 'row', alignItems: 'center', gap: 5 },
