...
export function LabsHeader({
  ...
  return (
    <>
      ...
      <View
        style={[styles.location, { backgroundColor: theme.colors.surface }]}
      >
        <View
          style={[styles.pin, { backgroundColor: theme.colors.primarySoft }]}
        >
          <MapPin color={theme.colors.primary} size={16} />
        </View>
        <View style={styles.locationCopy}>
          <AppText style={styles.locationName} weight="700">
            {location}
          </AppText>
