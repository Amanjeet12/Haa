...
export function GlobalStoreScreen({ navigation }: Props) {
  ...
  const globalQuantities =
    commerceCart.source === 'global'
      ? Object.fromEntries(
          commerceCart.items.map(item => [Number(item.id), item.quantity]),
        )
      : {};
      ...
      >
        ...
        <View style={styles.benefits}>
          ...
          >
            ...
            <AppText style={styles.benefitTitle} weight="800">
              Authenticity{`\n`}checked
            </AppText>
            <AppText color={theme.colors.textMuted} style={styles.benefitText}>
          ...
          >
            <PackageCheck color={theme.colors.primary} size={20} />
            <AppText style={styles.benefitTitle} weight="800">
              Protected{`\n`}delivery
            </AppText>
            <AppText color={theme.colors.textMuted} style={styles.benefitText}>
        ...
        <View style={styles.needHeader}>
          <View>
            <AppText style={styles.needTitle} weight="800">
              Shop by need
            </AppText>
            <AppText color={theme.colors.textMuted} style={styles.needSubtitle}>
            ...
            {categories.map(item => (
              ...
              >
                <ImageBackground
                  ...
                  source={
                    item.image?.url ? { uri: item.image.url } : images.careImage
                  }
                  resizeMode="cover"
        ...
        <ImageBackground
          ...
          imageStyle={styles.lifestyleCorners}
        />
        ...
        {productsLoading ? (
          ...
          productSections.map(section => (
            <WomensHormonalSection
              ...
              onRemove={product => {
                const item = commerceCart.items.find(
...
const styles = StyleSheet.create({
  ...
  needTitle: { fontSize: 20, lineHeight: 24 },
  needSubtitle: { marginTop: 3, fontSize: 9, lineHeight: 12 },
  categoriesState: {
    minHeight: 140,
    alignItems: 'center',
    justifyContent: 'center',
  ...
  needImage: { height: 96 },
  needImageCorners: { borderTopLeftRadius: 15, borderTopRightRadius: 15 },
  needLabel: {
    minHeight: 44,
    paddingHorizontal: 10,
    paddingVertical: 10,
  ...
  lifestyleCorners: { borderRadius: 18 },
  sectionHeading: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
