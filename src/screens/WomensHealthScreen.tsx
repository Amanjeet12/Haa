...
const products = [
  {
    id: 'balance',
    name: 'Advanced Hormone Balance Complex',
    detail: '60 capsules',
    price: 2499,
    oldPrice: 2799,
    discount: '11% OFF',
    seller: 'Evera Wellness · Global',
    image: images.onboardingCards,
  },
  {
    id: 'comfort',
    name: 'Electric Menstrual Comfort Belt',
    detail: 'USB-C device',
    price: 3299,
    oldPrice: 3699,
    discount: '10% OFF',
    seller: 'Nova Femme · Global',
    image: images.homeBanner,
  },
  {
    id: 'tracking',
    name: 'Fertility Tracking Sensor Kit',
    detail: 'Reusable sensor',
    price: 5999,
    oldPrice: 6499,
    discount: '8% OFF',
    seller: 'Ovia Tech · United States',
    image: images.careImage,
  },
  {
    id: 'microbiome',
    name: 'Daily Intimate Microbiome Care',
    detail: '30 capsules',
    price: 2199,
    oldPrice: 2499,
    discount: '12% OFF',
    seller: 'Flora Care · Canada',
    image: images.homeBanner,
  },
  {
    id: 'sleep',
    name: 'Women’s Rest & Sleep Support',
    detail: '45 capsules',
    price: 1899,
    oldPrice: 2099,
    discount: '9% OFF',
      ...
      <FlatList
          ...
          <>
            ...
            >
              ...
              <View style={styles.deliveryCopy}>
                ...
                <AppText style={styles.location} weight="800">
                  {zone?.zone_name ?? 'Rajbagh, Srinagar'}
                </AppText>
              </View>
              <AppText
            ...
            <View style={styles.controls}>
              ...
              >
                ...
                >
                  Search women’s health products
                </AppText>
              </Pressable>
              <Pressable
                onPress={() => setFiltersOpen(true)}
                style={[styles.filter, { backgroundColor: theme.colors.text }]}
              >
            ...
            <ImageBackground
              ...
              resizeMode="cover"
              imageStyle={styles.bannerCorners}
              style={styles.banner}
            >
              <LinearGradient
                colors={[
              ...
              >
                ...
                <AppText
                  ...
                  weight="800"
                >
                  Everyday hormonal support, from trusted global brands.
                </AppText>
                <AppText color="#F7DDE4" style={styles.bannerBody}>
                  Thoughtfully selected wellbeing, comfort and tracking
                  essentials.
                </AppText>
              </LinearGradient>
            </ImageBackground>
            <View style={styles.headingRow}>
              <View>
                ...
                <AppText color={theme.colors.textMuted} style={styles.count}>
                  {products.length} specialist products
                </AppText>
              </View>
              <AppText
                color={theme.colors.primary}
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <AppText style={styles.name} numberOfLines={2} weight="800">
              {item.name}
            </AppText>
            <View style={styles.meta}>
              ...
              <Clock3 size={8} color={theme.colors.textMuted} />
              <AppText color={theme.colors.textMuted} style={styles.metaText}>
                4–10 d
              </AppText>
            </View>
...
const styles = StyleSheet.create({
  ...
  bannerCorners: { borderRadius: 16 },
  bannerOverlay: { flex: 1, justifyContent: 'center', padding: 15 },
  bannerEyebrow: { fontSize: 7, letterSpacing: 0.7 },
  bannerTitle: { width: '70%', marginTop: 6, fontSize: 15, lineHeight: 18 },
  bannerBody: { width: '65%', marginTop: 7, fontSize: 7, lineHeight: 10 },
  headingRow: {
    flexDirection: 'row',
    alignItems: 'flex-end',
  ...
  art: { aspectRatio: 1.18, overflow: 'hidden', borderRadius: 8 },
  ...
  discountText: { fontSize: 6 },
  name: { minHeight: 29, marginTop: 5, fontSize: 9, lineHeight: 11 },
  meta: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    alignItems: 'center',
  ...
  price: { fontSize: 9 },
  oldPrice: { fontSize: 6, textDecorationLine: 'line-through' },
  add: {
    width: '40%',
    height: 27,
    borderRadius: 8,
