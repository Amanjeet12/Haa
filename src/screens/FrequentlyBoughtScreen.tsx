          ...
          <>
            ...
            >
              ...
              <View style={styles.deliveryCopy}>
                ...
                <AppText weight="800" numberOfLines={1} style={styles.location}>
            ...
            <View style={styles.intro}>
              ...
              <AppText weight="800" style={styles.heading}>
                {category ?? 'Your regular essentials'}
              </AppText>
              <AppText
                color={theme.colors.textMuted}
                style={styles.description}
              >
                A simple collection of the products you purchase most often.
              </AppText>
              <View style={styles.countRow}>
                <AppText weight="800" style={styles.count}>
                  {visibleProducts.length} products
                </AppText>
                <AppText color={theme.colors.textMuted} style={styles.updated}>
                  Updated from the last 90 days
                </AppText>
              </View>
            </View>
          </>
        ...
        renderItem={({ item }) => {
          return (
            ...
            >
              ...
              <AppText weight="800" style={styles.name}>
                {item.name}
              </AppText>
              <View style={styles.details}>
                <AppText color={theme.colors.textMuted} style={styles.detail}>
                  {item.detail}
                </AppText>
              ...
              <View style={styles.purchase}>
                <View style={styles.prices}>
                  <AppText weight="800" style={styles.price}>
                    ₹{item.price}
                  </AppText>
                  {item.oldPrice ? (
                    <AppText
                ...
                >
                  <AppText color="#FFFFFF" weight="800" style={styles.addText}>
                    ADD
                  </AppText>
                </Pressable>
              </View>
