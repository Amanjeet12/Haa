...
const products = [
  ...
  {
    id: 'care',
    name: 'Antiseptic Care Liquid',
    detail: '100 ml',
    price: 99,
    oldPrice: 110,
    discount: '10% OFF',
    seller: 'WellMart · 3 prices',
  ...
  {
    id: 'dressings',
    name: 'Sterile Adhesive Dressings',
    detail: '20 strips',
    price: 199,
    oldPrice: 220,
    discount: '10% OFF',
            ...
            >
              ...
              >
                ...
                <AppText
                  ...
                  weight="800"
                >
                  Everyday first aid, within minutes.
                </AppText>
                <AppText color="#D6E4EA" style={styles.bannerBody}>
                  Trusted home-care essentials from verified nearby stores.
                </AppText>
              </LinearGradient>
            </ImageBackground>
...
const styles = StyleSheet.create({
  ...
  deliveryCopy: { flex: 1 },
  deliveryLabel: { fontSize: 7, lineHeight: 9 },
  location: { fontSize: 10, lineHeight: 14 },
  eta: { fontSize: 8, lineHeight: 11 },
  controls: {
    flexDirection: 'row',
    gap: 8,
    paddingHorizontal: 14,
  ...
  bannerEyebrow: { fontSize: 7, letterSpacing: 0.8 },
  bannerTitle: { width: '66%', marginTop: 6, fontSize: 16, lineHeight: 18 },
  bannerBody: { width: '63%', marginTop: 7, fontSize: 7, lineHeight: 10 },
  headingRow: {
    flexDirection: 'row',
    alignItems: 'flex-end',
  ...
  heading: { fontSize: 17, lineHeight: 21 },
  ...
  discountText: { fontSize: 6, lineHeight: 8 },
  ...
  metaText: { fontSize: 6, lineHeight: 8 },
  seller: { marginTop: 2, fontSize: 6, lineHeight: 8 },
  purchase: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 3,
