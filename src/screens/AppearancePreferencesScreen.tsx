        ...
        <View style={styles.content}>
          ...
          >
            ...
            <ModeRow
              ...
              title="Light mode"
              subtitle="A bright and clear appearance"
              value="light"
          ...
          >
            <AppText color={theme.colors.textMuted} style={styles.noteText}>
              Your preference is applied across Haa Health and saved on this
              device.
            </AppText>
          </View>
        </View>
  ...
  return (
    ...
    >
      ...
      <View style={styles.grow}>
        ...
        <AppText color={theme.colors.textMuted} style={styles.modeSubtitle}>
          {subtitle}
        </AppText>
      </View>
      <View
      ...
      >
        {selected ? (
          <Check color={theme.colors.onPrimary} size={14} strokeWidth={3} />
        ) : null}
      </View>
    </Pressable>
  );
...
const styles = StyleSheet.create({
  ...
  content: { padding: 18 },
  title: { marginTop: 18, fontSize: 25, lineHeight: 30 },
  subtitle: { marginTop: 6, maxWidth: 330, fontSize: 11, lineHeight: 16 },
  card: { borderWidth: 1, borderRadius: 18, marginTop: 24, overflow: 'hidden' },
  mode: {
    minHeight: 72,
  ...
  grow: { flex: 1 },
  modeTitle: { fontSize: 12, lineHeight: 16 },
  modeSubtitle: { marginTop: 2, fontSize: 9, lineHeight: 12 },
  radio: {
    width: 24,
    height: 24,
    borderWidth: 1.5,
  ...
  note: { borderRadius: 13, marginTop: 12, padding: 13 },
  noteText: { fontSize: 9, lineHeight: 13, textAlign: 'center' },
});
